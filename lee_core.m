function dydt = lee_core(t,y,params,PI3K,Erk)
...
dydt(3,1)= kAP*PI3K_t*Akt/(KAP+Akt)-(kAD*Akt_p)/(KAD+Akt_p); 
dydt(4,1)= -kGP*Akt_p*Gsk3b/(KGP+Gsk3b)+kGD*Gsk3b_p/(KGD+Gsk3b_p);
